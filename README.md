...
Röportaj bitince şablonun `origin` bağlantısı `template` olarak yeniden adlandırılır:
kendi deponu `origin` olarak ekleyebilirsin, şablon güncellemelerini de
`git fetch template` ile çekebilirsin.
